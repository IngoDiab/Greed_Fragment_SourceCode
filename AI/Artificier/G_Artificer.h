...
#include "G_Artificer.generated.h"

class UG_FleeComponent;

UCLASS()
class GREED_API AG_Artificer : public AG_BaseMobSKM, public IFleeingMob
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(VisibleAnywhere, Category = "Mesh Cannon", meta = (DisplayName = "Cannon Mesh"), BlueprintReadWrite)
	UStaticMeshComponent* mCannonMesh = nullptr;
